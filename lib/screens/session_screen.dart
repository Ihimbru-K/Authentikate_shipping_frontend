...
class _SessionScreenState extends State<SessionScreen> {
  String? _courseCode; // Changed from int? _courseId
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Schedule Exam'), centerTitle: true,),
      body: Padding(
            ...
            children: [
              CustomDropdown<String>(
                ...
                items: _courses.map((course) => DropdownMenuItem<String>(
                  value: course['course_code'] as String, // Use course_code instead of course_id
              ...
              CustomButton(
                text: 'Create',
                onPressed: _courseCode != null
                    ? () async {
                  try {
                    await SessionService.create(_courseCode!, _startTime, _endTime);
